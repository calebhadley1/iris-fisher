...
def train_dec_tree(X, y, model_path):
    ...
    logger.info(f"DecisionTreeClassifier Training Complete. Pickle can be found at: {model_path}\n")


def train_rfc(X, y, model_path):
    logger.info("Training RandomForestClassifier...")
    train_linear_model(X, y, RandomForestClassifier(), model_path)
    logger.info(f"RandomForestClassifier Training Complete. Pickle can be found at: {model_path}\n")
...
def train_gbc(X, y, model_path):
    ...
    logger.info(f"GradientBoostingClassifier Training Complete. Pickle can be found at: {model_path}\n")
